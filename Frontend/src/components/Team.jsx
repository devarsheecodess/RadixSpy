    ...
    return (
        <div className="min-h-screen relative">
            <main className="relative flex flex-col items-center min-h-screen">
                ...
                {/* Title */}
                <h1 className="font-bold text-4xl fade-in-up z-10 mt-16 text-white tracking-wide">Meet Our Team</h1>

                {/* Team Cards */}
                <div className="relative z-20 mt-12 flex gap-16 slide-in-text">
                    {/* Card 1 */}
                    <div className="h-96 w-72 rounded-xl bg-white shadow-xl flex flex-col items-center p-6 transform hover:scale-105 transition-transform duration-300 ease-out">
                        ...
                        <div className='flex gap-4 mt-5'>
                            <a href="https://www.linkedin.com/in/devarshee-gaunekar-a06441257/" target="_blank" rel="noopener noreferrer">
                                <i class="fa-brands fa-linkedin text-2xl text-blue-600 hover:text-blue-800 transition-colors duration-200 ease-in-out"></i>
                            </a>
                            <a href="https://instagram.com/devarsheegaunekar" target="_blank" rel="noopener noreferrer">
                                <i class="fa-brands fa-instagram text-2xl text-pink-500 hover:text-pink-700 transition-colors duration-200 ease-in-out"></i>
                            </a>
                            <a href="https://github.com/devarsheecodess" target="_blank" rel="noopener noreferrer">
                                <i class="fa-brands fa-github text-2xl text-gray-800 hover:text-black transition-colors duration-200 ease-in-out"></i>
                            </a>
                        </div>
                    </div>
